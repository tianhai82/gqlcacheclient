(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("gql-cache-client", [], factory);
	else if(typeof exports === 'object')
		exports["gql-cache-client"] = factory();
	else
		root["gql-cache-client"] = factory();
})(global, function() {
...
var GqlClient = function () {
  function GqlClient(endpoint, headers) {
  ...
  _createClass(GqlClient, [{
    ...
    value: function request(query, variables, options) {
      ...
      return fetchQuery(this.endpoint, this.headers, queryDoc.definitions[0].name ? queryDoc.definitions[0].name.value : null, query, variables).then(function (data) {
...
//# sourceMappingURL=gql-cache-client.js.map