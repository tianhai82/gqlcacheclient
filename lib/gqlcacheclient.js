...
var _printer = __webpack_require__(/*! graphql/language/printer */ "graphql/language/printer");
...
var GqlClient = function () {
  ...
  _createClass(GqlClient, [{
    ...
    value: function request(query, variables, options) {
      ...
      var queryDoc = void 0;
      var isDoc = false;
      if ((typeof query === 'undefined' ? 'undefined' : _typeof(query)) === 'object' && query.kind && typeof query.kind === 'string' && query.kind.toLowerCase() === 'document') {
        isDoc = true;
      }
      if (!isDoc) {
        try {
      ...
      var promise = fetchQuery(this.endpoint, this.headers, queryDoc.definitions[0].name ? queryDoc.definitions[0].name.value : null, (0, _printer.print)(queryDoc), variables).then(function (data) {
